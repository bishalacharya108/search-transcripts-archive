...
*/}
                        ...
                        <div className="item-end mx-3 bottom-0 self-center mt-5">
                            <Image src={`${(title && markdown && videoUrl) ? "/aum_golden.svg" : "/aum_dark.svg"}`} width={200} height={200} alt="Upload"></Image>
            ...
            <dialog id="my_modal_5" className="modal modal-bottom sm:modal-middle text-center ">
                <div className="translate-0 p-2 bg-base-200 w-[40vw] h-[50vh] inset-0 rounded-md">
                    <div className="flex justify-center py-2">
                        {/*TODO: should try using checkbox svg instead of checkmark to save space*/}
